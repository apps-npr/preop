...
const procedureDatabase = [
    ...
    { name: "Cataract surgery / Glaucoma intervention (ผ่าตัดต้อกระจก, ต้อหิน), ขูดหินปูน, ทำฟันปลอม, รักษารากฟัน, ผ่าตัดเหงือก)", risk: "minimal", riskLabel: "Minimal Risk" },
    { name: "Minor dermatologic excision (ตัดไฝ, หูด, มะเร็งผิวหนังขนาดเล็ก, ผ่าตัดผิวหนังส่วนตื้น)", risk: "minimal", riskLabel: "Minimal Risk" },
    ...
    { name: "Central venous catheter removal / Vascular access / IV port (ถอดสายสวนหลอดเลือดดำใหญ่, แทงเส้นเลือด)", risk: "minimal", riskLabel: "Minimal Risk" },
    { name: "Joint injections / Arthrocentesis (เจาะน้ำในข้อ, ฉีดยาเข้าข้อ)", risk: "minimal", riskLabel: "Minimal Risk" },
    { name: "Lumbar puncture (เจาะน้ำไขสันหลัง)", risk: "minimal", riskLabel: "Minimal Risk" },
    { name: "Incision of abscess (กรีดระบายหนอง)", risk: "minimal", riskLabel: "Minimal Risk" },
    { name: "Endoscopy without surgery/biopsy (ส่องกล้องทางเดินอาหารแบบไม่ตัดชิ้นเนื้อ)", risk: "minimal", riskLabel: "Minimal Risk" },
    { name: "Imaging studies: MRI, CT (การตรวจทางภาพถ่ายรังสี)", risk: "minimal", riskLabel: "Minimal Risk" },

    // 🟠 Low/Moderate Risk (0-2% major bleed)
    { name: "Arthroscopy (ส่องกล้องข้อเข่า, ข้อไหล่)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Cutaneous / Lymph node biopsy (ตัดชิ้นเนื้อผิวหนัง, ต่อมน้ำเหลือง)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Foot / Hand surgery / Carpal tunnel repair (ผ่าตัดมือ, ผ่าตัดเท้า, ผ่าตัดพังผืดทับเส้นประสาทข้อมือ),", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Coronary angiography / Non-coronary angiography (ฉีดสีดูหลอดเลือดหัวใจ หรือหลอดเลือดอื่นๆ)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Gastroscopy / Colonoscopy / Endoscopy + biopsy/tissue removal (ส่องกล้องกระเพาะอาหาร/ลำไส้ใหญ่ และตัดชิ้นเนื้อ)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Abdominal hysterectomy / D&C / Major gynecologic surgery (ตัดมดลูกทางหน้าท้อง, ขูดมดลูก, นรีเวช)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Laparoscopic Cholecystectomy / Open Cholecystectomy (ผ่าตัดถุงน้ำดี)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Abdominal / Inguinal / Hiatal hernia repair (ผ่าตัดไส้เลื่อนหน้าท้อง, ขาหนีบ, กระบังลม)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Hemorrhoidal surgery (ผ่าตัดริดสีดวงทวาร)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Bronchoscopy + biopsy (ส่องกล้องหลอดลมและตัดชิ้นเนื้อ)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "FESS / Endoscopic Sinus Surgery (ผ่าตัดไซนัสผ่านกล้อง)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Dental extraction ≥ 3 teeth (ถอนฟันตั้งแต่ 3 ซี่ขึ้นไป)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Breast surgery (ผ่าตัดเต้านม)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Thyroid / Endocrine surgery (ผ่าตัดต่อมไทรอยด์, ต่อมไร้ท่อ)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Prostate / Bladder biopsy (เจาะชิ้นเนื้อต่อมลูกหมาก, กระเพาะปัสสาวะ)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Hydrocele repair (ผ่าตัดถุงน้ำอัณฑะ)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "EPS / RF ablation for SVT (จี้ไฟฟ้าหัวใจเต้นผิดจังหวะชนิดไม่ซับซ้อน)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Peripheral arterial angioplasty / EVAR (ทำบอลลูนหลอดเลือดส่วนปลาย, ซ่อมหลอดเลือดโป่งพองผ่านสายสวน)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },
    { name: "Splenectomy (ผ่าตัดม้าม)", risk: "low-mod", riskLabel: "Low/Moderate Risk" },

    // 🔴 High Risk (>= 2% major bleed)
    { name: "Major surgery / Extensive tissue injury (ผ่าตัดใหญ่เนื้อเยื่อช้ำมาก)", risk: "high", riskLabel: "High Risk" },
    { name: "Cancer surgery / Solid tumor (ผ่าตัดมะเร็งก้อนโต เช่น ปอด, ลำไส้, ตับอ่อน, เต้านมแบบลุกลาม)", risk: "high", riskLabel: "High Risk" },
    { name: "Major orthopedic / Joint replacement (ผ่าตัดเปลี่ยนข้อเข่า, สะโพก, ไหล่)", risk: "high", riskLabel: "High Risk" },
    { name: "Reconstructive plastic surgery (ศัลยกรรมตกแต่งแก้ไข, ปลูกถ่ายเนื้อเยื่อ)", risk: "high", riskLabel: "High Risk" },
    { name: "Major thoracic surgery / Pneumonectomy (ผ่าตัดช่องอกใหญ่, ตัดปอด)", risk: "high", riskLabel: "High Risk" },
    { name: "Urologic / GI anastomosis / Oesophagectomy (ผ่าตัดทางเดินอาหาร/ปัสสาวะที่มีการต่อท่อ, ตัดหลอดอาหาร)", risk: "high", riskLabel: "High Risk" },
    { name: "TURP / Bladder resection / Total cystectomy (ขูดต่อมลูกหมากผ่านท่อปัสสาวะ, ตัดกระเพาะปัสสาวะ)", risk: "high", riskLabel: "High Risk" },
    { name: "Nephrectomy / Kidney biopsy (ตัดไต, เจาะชิ้นเนื้อไต)", risk: "high", riskLabel: "High Risk" },
    { name: "Colonic polyp resection (ส่องกล้องตัดติ่งเนื้อลำไส้ใหญ่)", risk: "high", riskLabel: "High Risk" },
    { name: "Bowel resection / Subtotal colectomy / Abdominoperineal resection (ตัดต่อลำไส้)", risk: "high", riskLabel: "High Risk" },
    { name: "PEG placement (เจาะสายให้อาหารทางหน้าท้อง)", risk: "high", riskLabel: "High Risk" },
    { name: "ERCP (ส่องกล้องท่อน้ำดีและตับอ่อน)", risk: "high", riskLabel: "High Risk" },
    { name: "Surgery in highly vascular organs / Adrenal resection (ผ่าตัดอวัยวะเลือดออกง่าย เช่น ตับ, ม้าม, ไต, ต่อมหมวกไต)", risk: "high", riskLabel: "High Risk" },
    { name: "Cardiac surgery / CABG / Heart valve replacement (ผ่าตัดหัวใจ, บายพาส, เปลี่ยนลิ้นหัวใจ)", risk: "high", riskLabel: "High Risk" },
    { name: "Complex left-sided ablation (จี้ไฟฟ้าหัวใจชนิดซับซ้อน เช่น PVI, VT ablation)", risk: "high", riskLabel: "High Risk" },
    { name: "Major Vascular surgery / AAA repair / Limb revascularization (ผ่าตัดหลอดเลือดใหญ่, ตัดต่อหลอดเลือดแขนขา)", risk: "high", riskLabel: "High Risk" },
    { name: "Trauma surgery / Multiple trauma (ผ่าตัดอุบัติเหตุรุนแรง)", risk: "high", riskLabel: "High Risk" },
    { name: "Any major operation > 45 min (การผ่าตัดที่นานกว่า 45 นาที)", risk: "high", riskLabel: "High Risk" },
    ...
    { name: "Trigeminal / Ophthalmic / Sphenopalatine ganglion blocks (ฉีดยาบล็อกเส้นประสาทใบหน้า)", risk: "high", riskLabel: "High Risk" },
    { name: "Peripheral nerve stimulation trial/implant (ฝังเครื่องกระตุ้นเส้นประสาท)", risk: "high", riskLabel: "High Risk" },
    ...
    { name: "Spinal surgery / Spinal canal procedures (ผ่าตัดกระดูกสันหลัง / ไขสันหลัง)", risk: "neuro-spine", riskLabel: "Neuroaxial/Critical Site" },
    { name: "Neuraxial anesthesia (บล็อกหลัง, แทงเข็มไขสันหลัง)", risk: "neuro-spine", riskLabel: "Neuroaxial/Critical Site" },
